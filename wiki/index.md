...
- [AgentGuard](agentguard.md): reliability middleware (value- and pattern-redacted single-root causal span tracing with honest Codex item status/attributes, diagnose, detect, recover, proactive budget, HITL).
